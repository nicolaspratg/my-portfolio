  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Full-stack developer based in Vienna. Building fast, clear, and scalable web applications with React, TypeScript, and Node.js." />
